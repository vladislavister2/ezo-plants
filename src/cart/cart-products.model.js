...
var CartProducts = /** @class */ (function (_super) {
    __extends(CartProducts, _super);
    ...
    ], CartProducts.prototype, "productID");
    CartProducts = __decorate([
