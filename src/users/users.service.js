...
var UsersService = /** @class */ (function () {
    function UsersService(usersRepository, roleService, cartService) {
    ...
    UsersService.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.usersRepository.findAll({ include: { all: true } })];
            });
        });
    };
    UsersService.prototype.getById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.usersRepository.findByPk(id)];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        role = _a.sent();
                        return [4 /*yield*/, newUser.$set('roles', [role.id])];
                    case 3:
                        _a.sent();
                        newUser.roles = [role];
                        return [4 /*yield*/, this.cartService.create(newUser.id)];
                    case 4:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, user.update(updateUserDto)];
                }
            });
        });
    };
